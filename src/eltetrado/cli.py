...
def eltetrado_cli(args=sys.argv[1:]):
    ...
    parser.add_argument("--fr3d-txt", help="(optional) path to fr3d txt file")
    parser.add_argument(
    ...
    if args.dssr_json is not None:
        base_interactions = parse_external_output(
            args.dssr_json, ExternalTool.DSSR, structure3d
        )
    elif args.fr3d_txt is not None:
        base_interactions = parse_external_output(
            args.fr3d_txt, ExternalTool.FR3D, structure3d
        )
    else:
